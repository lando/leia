...
module.exports = class Leia {
   ...
   * @param {Object} [options] Typed renderer options
   * @param {Boolean} [options.strip=false] Strip static template whitespace
   * @param {String} [options.moduleFormat=commonjs] Fallback format for metadata without a format
   * @return {Array} An array of unique absolute filepaths
   */
