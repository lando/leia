 ...
 * @param {Boolean} spawn A boolean to spawn instead of exec
 ...
 */
module.exports = (tests, spawn = false, opts = {strip: false}) => {
  // Template dir
  ...
  const templateFile = path.join(templateDir, spawn ? 'spawn.test.jst' : 'exec.test.jst');
